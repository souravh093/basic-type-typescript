"use strict";
{
     ...
     */
    function company(user, companyName) {
        return Object.assign(Object.assign({}, user), { companyName });
    }
    console.log(company({ id: 102, name: "Sourav Halder", age: 24 }, "MNTECH Digital"));
    ...
    const modernUser = (user, address) => {
        return Object.assign(Object.assign({}, user), address);
    };
    console.log(modernUser({ id: 105, name: "Sourave Halder", age: 24 }, {
        city: "Barishal",
        country: "Bangladesh",
        postalCode: 8200,
